      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-border/20 pt-8 pb-4 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/sur_iix_?igsh=MWVxdjF4dGcyMjV6Nw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass flex items-center justify-center text-muted-foreground hover:text-[#E4405F] hover:scale-110 transition-all bg-white/5 shadow-sm" aria-label="Instagram">
